document.addEventListener('DOMContentLoaded', () => {
    ...
    //mvoe the tetromino right, unless is at the edge or there is a blockage
    function moveRight() {
        undraw()
    ...
    function rotate() {
        undraw()
        currentRotation ++
        if(currentRotation === current.length) { //if the current roation gets to 4, make it g back to 0
            currentRotation = 0
        }
        current = theTetrominoes[random][currentRotation]
        draw()
